...
console.log("*******************************************8");
context.returnFoo = returnFoo;           //brainfuck!
context.returnFoo(); // => bar
console.log("context.returnFoo()=" + context.returnFoo());
let newVar = context.returnFoo = returnFoo;
console.log("context.returnFoo = returnFoo" + newVar);
